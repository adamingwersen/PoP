...
\section*{g6.2}
\section*{g6.3}
I funktionen colourAt tilføjes et argument yderligere til match'et: 
\lstinputlisting[language=FSharp]{}
        
\section*{g6.4}
\begin{figure}[H]
\centering
\includegraphics[scale = 1]{dublet.png}
\caption{g63.bmp $\rightarrow$ g63.png}
\end{figure}
\section*{g6.5}
